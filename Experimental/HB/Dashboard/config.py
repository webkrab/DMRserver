REPORT_NAME     = 'Webkrab'  # Name of the monitored HBlink system
CONFIG_INC      = True                  # Include HBlink stats
BRIDGES_INC     = True                  # Include Bridge stats (confbrige.py)
HBLINK_IP       = '127.0.0.1'           # HBlink's IP Address
HBLINK_PORT     = 4321                  # HBlink's TCP reporting socket
FREQUENCY       = 60                    # Frequency to push updates to web clients
...
PATH            = '/home/dmr/Desktop/Server/HB/Dashboard/'                          # MUST END IN '/'
...
LOG_PATH        = '/home/dmr/Desktop/Server/LOGS/'             # MUST END IN '/'
LOG_NAME        = 'hbmonitor.log'
